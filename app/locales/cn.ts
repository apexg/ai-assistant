...
const cn = {
  ...
  Chat: {
    SubTitle: (count: number) => `与 爱德AI 的 ${count} 条对话`,
    Actions: {
      ChatList: "查看消息列表",
  ...
  Export: {
    ...
    MessageFromChatGPT: "来自 爱德AI 的消息",
  },
  Memory: {
    Title: "历史记忆",
    EmptyContent: "尚未记忆",
  ...
  Home: {
    ...
    Logout: "退出",
    NoLogin: "未登录",
    Offline: "您已在别处登录，将在10秒后强制下线。",
    OnlineCount: (count: number) => `${count} 人在线`,
    MsgCount: (count: number) => `${count} 最新问题`,
    StatTitle: "在线统计",
    StatFilterLabel: "最近",
    StatFilterMinute: "分钟",
    StatFilterHour: "小时",
