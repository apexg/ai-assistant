...
const de: LocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} Nachrichten mit Chat Bot`,
    Actions: {
    ...
    UserHeartbeatFail: "User heartbeat failure",
  },
  Export: {
    ...
    MessageFromChatGPT: "Nachricht von Chat Bot",
  },
  Memory: {
